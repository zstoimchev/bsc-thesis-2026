...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | ----------------- | -------------- | --------- |
| [\[01\]](https://isyou.info/jisis/vol9/no4/jisis-2019-vol9-no4-01.pdf)                                                                                     | [DeepLearning-IDS](https://github.com/Colorado-Mesa-University-Cybersecurity/DeepLearning-IDS)           | YES               | Yes            | Yes       |
...
| \[03\]                                                                                                                                                     | [Anomaly-Detection-KDD99-CNNLSTM](https://github.com/perriDplatypus/Anomaly-Detection-KDD99-CNNLSTM)     | YES               | No             | Not yet   |
| [\[04\]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8449272)                                                                                 | [Intrusion-Detection-on-NSL-KDD](https://github.com/hymoe/Intrusion-Detection-on-NSL-KDD)                | Yes               | Yes            | Not yet   |

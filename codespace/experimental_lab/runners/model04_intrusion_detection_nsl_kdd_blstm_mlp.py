...
def parse_args(argv: list[str] | None = None) -> RunnerArgs:
    parser = argparse.ArgumentParser(
        description="Paper 4 / Intrusion-Detection-on-NSL-KDD BLSTM + MLP runner."
    )
...
def run_blstm_mlp(args: RunnerArgs) -> dict[str, Any]:
    try:
        import tensorflow as tf
    except ImportError:
        return write_audit_only_result(
            ...
            message=(
                ...
                "to execute this Paper 4 BLSTM + MLP runner."
            ),
            details={
    ...
    model_path = artifact_dir / "blstm_mlp.keras"
    ...
    metrics.update(
        {
            ...
            "runner": "model04_intrusion_detection_nsl_kdd_blstm_mlp",
            "paper": "04",
            "repository": "Intrusion-Detection-on-NSL-KDD",
            "variant": "blstm_mlp",
            "problem_type": args.problem_type,

...
def parse_args(argv: list[str] | None = None) -> RunnerArgs:
    parser = argparse.ArgumentParser(
        description="Paper 6 / CIC-DDoS2019 Deep Learning LSTM runner."
    )
...
def run_lstm(args: RunnerArgs) -> dict[str, Any]:
    try:
        import tensorflow as tf
    except ImportError:
        return write_audit_only_result(
            ...
            message=(
                ...
                "to execute this Paper 6 LSTM runner."
            ),
            details={
    ...
    model_path = artifact_dir / "lstm.keras"
    ...
    metrics.update(
        {
            ...
            "runner": "model06_cic_ddos2019_deeplearning_lstm",
            "paper": "06",
            "repository": "CIC-DDoS2019-DeepLearning",
            "variant": "lstm",
            "problem_type": args.problem_type,

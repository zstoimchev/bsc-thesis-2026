...
def parse_args(argv: list[str] | None = None) -> RunnerArgs:
    parser = argparse.ArgumentParser(
        description="Paper 6 / CIC-DDoS2019 Deep Learning GRU runner."
    )
...
def reshape_tabular_to_sequence(X):
    """
    Convert tabular flow features to a sequence shape for GRU.
...
def run_gru(args: RunnerArgs) -> dict[str, Any]:
    try:
        import tensorflow as tf
    except ImportError:
        return write_audit_only_result(
            ...
            message=(
                ...
                "to execute this Paper 6 GRU runner."
            ),
            details={
    ...
    model_path = artifact_dir / "gru.keras"
    ...
    metrics.update(
        {
            ...
            "runner": "model06_cic_ddos2019_deeplearning_gru",
            "paper": "06",
            "repository": "CIC-DDoS2019-DeepLearning",
            "variant": "gru",
            "problem_type": args.problem_type,

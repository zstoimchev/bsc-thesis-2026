...
def parse_args(argv: list[str] | None = None) -> RunnerArgs:
    parser = argparse.ArgumentParser(
        description="Paper 4 / Intrusion-Detection-on-NSL-KDD GRU + MLP runner."
    )
...
def run_gru_mlp(args: RunnerArgs) -> dict[str, Any]:
    try:
        import tensorflow as tf
    except ImportError:
        return write_audit_only_result(
            ...
            message=(
                ...
                "to execute this Paper 4 GRU + MLP runner."
            ),
            details={
    ...
    model_path = artifact_dir / "gru_mlp.keras"
    ...
    metrics.update(
        {
            ...
            "runner": "model04_intrusion_detection_nsl_kdd_gru_mlp",
            "paper": "04",
            "repository": "Intrusion-Detection-on-NSL-KDD",
            "variant": "gru_mlp",
            "problem_type": args.problem_type,

...
def parse_args(argv: list[str] | None = None) -> RunnerArgs:
    parser = argparse.ArgumentParser(
        description="Paper 6 / CIC-DDoS2019 Deep Learning CNN-LSTM runner."
    )
...
def reshape_tabular_to_sequence(X):
    """
    Convert tabular flow features to sequence format.
    ...
    try:
        ...
        return write_audit_only_result(
            ...
            message=(
                ...
                "to execute this Paper 6 CNN-LSTM runner."
            ),
            details={
    ...
    metrics.update(
        {
            ...
            "runner": "model06_cic_ddos2019_deeplearning_cnn_lstm",
            "paper": "06",
            "repository": "CIC-DDoS2019-DeepLearning",
            "variant": "cnn_lstm",
            "problem_type": args.problem_type,

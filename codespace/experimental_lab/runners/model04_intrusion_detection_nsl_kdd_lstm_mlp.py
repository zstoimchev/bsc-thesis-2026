...
def parse_args(argv: list[str] | None = None) -> RunnerArgs:
    parser = argparse.ArgumentParser(
        description="Paper 4 / Intrusion-Detection-on-NSL-KDD LSTM + MLP runner."
    )
...
def run_lstm_mlp(args: RunnerArgs) -> dict[str, Any]:
    try:
        import tensorflow as tf
    except ImportError:
        return write_audit_only_result(
            ...
            message=(
                ...
                "to execute this Paper 4 LSTM + MLP runner."
            ),
            details={
    ...
    model_path = artifact_dir / "lstm_mlp.keras"
    ...
    metrics.update(
        {
            ...
            "runner": "model04_intrusion_detection_nsl_kdd_lstm_mlp",
            "paper": "04",
            "repository": "Intrusion-Detection-on-NSL-KDD",
            "variant": "lstm_mlp",
            "problem_type": args.problem_type,
